...
with DAG(
    ...
    t1 = PythonOperator(task_id="directions", python_callable=directions)
    t2 = PythonOperator(task_id="levels", python_callable=levels)
    ...
    t9 = PythonOperator(task_id="wp_markup", python_callable=wp_markup)
    t10 = PythonOperator(task_id="wp_online_sourse", python_callable=wp_online_sourse)
